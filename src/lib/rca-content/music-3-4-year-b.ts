// ARCHIVED REFERENCE ONLY — not this year's curriculum. 2026-2027 is Music A
// (see music-3-4.ts); this is the Year B content that was mistakenly loaded as
// current from 2026-08-09 to 2026-08-21 before the mixup was caught. RCA's
// Music 3-4 alternates Year A/Year B by academic year, so this becomes real
// again whenever RCA runs Year B next — kept for that, not deleted.
//
...
export const music34OverviewYearB =
...
export const music34LessonsYearB: MusicLessonYearB[] = [
...
export const music34Content: SubjectContent = {
  overview: music34OverviewYearB,
  lessons: music34LessonsYearB.map((l) => ({
    n: l.n,
    sections: [
