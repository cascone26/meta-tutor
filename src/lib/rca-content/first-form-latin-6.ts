...
//
// 2026-09-09: Cross-checked lesson-by-lesson against Jacob's own physical copy of
// the Memoria Press First Form Latin Teacher Guide (photographed page-by-page,
// ~/Desktop/MT;RCAmaterial) and added the REAL topic of each lesson in parentheses
// at its first "Teach Lesson ___" mention — Lessons I-X and XII-XXXIII confirmed
// directly off the photographed Teacher Guide pages (grammar-chart title + Latin
// Saying on each lesson's opening spread). Lesson XI was not among the photographed
// pages, so it's deliberately left unannotated rather than guessed — everything
// else here is a direct read, not an inference.
...
export const firstFormLatin6Content: SubjectContent = {
  ...
  lessons: [
    ...
    { n: 5, sections: [{ label: "Week 5 (Sep 14-18)", text: "Monday — Teach Lesson IV (Present System Review; the Infinitive & Principal Parts introduced), following the Teacher's Manual." }, { label: "Week 5 (Sep 14-18)", text: "Thursday — Practice Lesson IV — saying, grammar forms, & vocabulary. Do Lesson IV - Ex. IV together." }] },
    { n: 6, sections: [{ label: "Week 6 (Sep 21-25)", text: "Monday — Teach Lesson V (Irregular Verb sum, Present System), following the Teacher's Manual. Do Lesson V — half of each section of Ex. IV and V." }, { label: "Week 6 (Sep 21-25)", text: "Thursday — Practice Lesson IV-V — saying, grammar forms, & vocabulary. Latin Quiz: Lesson IV-V. HW Check: Lesson IV - Ex. II, III, V & Lesson V - Ex. II, III, IV, V." }] },
    { n: 7, sections: [{ label: "Week 7 (Sep 28-2)", text: "Monday — Teach Lesson VI (Unit I Review — Milestone Marker 1), following the Teacher's Manual. Do Lesson VI — half of each section of Ex. IV and V." }, { label: "Week 7 (Sep 28-2)", text: "Thursday — Practice Lesson VI — saying, grammar forms, & vocabulary. Latin Quiz: Lesson VI. HW Check: Lesson VI - Ex. II, III, second half of IV, V." }] },
    { n: 8, sections: [{ label: "Week 8 (Oct 5-9)", text: "Monday — Teach Lesson VII (Principal Parts, First Conjugation), following the Teacher's Manual." }, { label: "Week 8 (Oct 5-9)", text: "Thursday — Practice Lesson VII-VIII — saying, grammar forms, & vocabulary. Do Lesson VIII (First Conjugation Perfect Tense) - Ex. I and III, check and correct." }] },
    ...
    { n: 10, sections: [{ label: "Week 10 (Oct 26-30)", text: "Monday — Teach Lesson IX (First Conjugation Pluperfect Tense), following the Teacher's Manual." }, { label: "Week 10 (Oct 26-30)", text: "Thursday — Do Lesson IX - Ex. V. Begin teaching Lesson X (First Conjugation Future Perfect Tense), following the Teacher's Manual." }] },
    ...
    { n: 12, sections: [{ label: "Week 12 (Nov 9-13)", text: "Monday — Teach Lesson XI, following the Teacher's Manual." }, { label: "Week 12 (Nov 9-13)", text: "Thursday — Teach Lesson XII (Unit II Review — Perfect System of the 1st Conjugation & sum), following the Teacher's Manual." }] },
    ...
    { n: 14, sections: [{ label: "Week 14 (Nov 30-4)", text: "Monday — Briefly discuss the Unit II Introduction. Teach Lesson XIV (First Declension Nouns — Unit III Intro), following the Teacher's Manual (Lesson XIII is skipped this year)." }, { label: "Week 14 (Nov 30-4)", text: "Thursday — Teach Lesson XV (Second Declension Nouns), following the Teacher's Manual." }] },
    ...
    { n: 16, sections: [{ label: "Week 16 (Dec 14-18)", text: "Monday — Teach Lesson XVI (Second Declension Neuter Nouns), following the Teacher's Manual." }, { label: "Week 16 (Dec 14-18)", text: "Thursday — Practice Lesson XVI. Do Lesson XVI - Ex. IV, Drill D. Introduce Lesson XVII." }], note: "End of fall semester; Christmas Break follows." },
    { n: 17, sections: [{ label: "Week 17 (Jan 4-8)", text: "Monday — Teach Lesson XVII (First & Second Declension Review), following the Teacher's Manual. Work on the Mastery Goals (p. 47)." }, { label: "Week 17 (Jan 4-8)", text: "Thursday — Practice Lesson XVI-XVII. Latin Quiz: Lesson XVI-XVII. HW Check: Lesson XVI - Ex. I, III, IV, VI & Lesson XVII - Ex. II, III, V." }], note: "Resume after Christmas Break; spring semester begins." },
    { n: 18, sections: [{ label: "Week 18 (Jan 11-15)", text: "Monday — Teach Lesson XVIII (First & Second Declension Adjectives), following the Teacher's Manual." }, { label: "Week 18 (Jan 11-15)", text: "Thursday — Practice Lesson XVIII. Introduce Lesson XIX." }] },
    { n: 19, sections: [{ label: "Week 19 (Jan 18-22)", text: "Monday — Teach Lesson XIX (Numbers 1-10, Cardinal & Ordinal), following the Teacher's Manual." }, { label: "Week 19 (Jan 18-22)", text: "Thursday — Practice Lesson XVIII-XIX. Latin Quiz: Lesson XVIII-XIX. HW Check: Lesson XVIII - Ex. I, III, IV & Lesson XIX - Ex. I, III, IV, VI." }] },
    { n: 20, sections: [{ label: "Week 20 (Jan 25-29)", text: "Monday — Teach Lesson XX, Unit III Review (Mini-Milestone). Work on the Mastery Goals." }, { label: "Week 20 (Jan 25-29)", text: "Thursday — Practice Lesson XX. Latin Quiz: Lesson XX. HW Check: Lesson XX - Ex. III, IV, V, VI." }] },
    { n: 21, sections: [{ label: "Week 21 (Feb 1-5)", text: "Monday — Briefly discuss the Unit IV Introduction. Teach Lesson XXI (Third Declension, Masculine & Feminine), following the Teacher's Manual. Start Ex. III." }, { label: "Week 21 (Feb 1-5)", text: "Thursday — Practice Lesson XXI. Introduce Lesson XXII." }], note: "Mid-Winter Break follows." },
    { n: 22, sections: [{ label: "Week 22 (Feb 8-12)", text: "Monday — Teach Lesson XXII (Third Declension Masc/Fem — extra practice week), following the Teacher's Manual." }, { label: "Week 22 (Feb 8-12)", text: "Thursday — Practice Lesson XXI-XXII. Latin Quiz: Lesson XXI-XXII. HW Check: Lesson XXI - Ex. I, III, VI & Lesson XXII - Ex. I, II, V, VI." }], note: "Resume after Mid-Winter Break." },
    { n: 23, sections: [{ label: "Week 23 (Feb 22-26)", text: "Monday — Teach Lesson XXIII (Third Declension Neuter), following the Teacher's Manual." }, { label: "Week 23 (Feb 22-26)", text: "Thursday — Practice Lesson XXIII. Do Lesson XXIII - Ex. VII. Introduce Lesson XXIV." }] },
    ...
    { n: 30, sections: [{ label: "Week 30 (Apr 26-30)", text: "Monday — Teach Lesson XXXI (Second Conjugation Principal Parts), following the Teacher's Manual." }], note: "Feast of the Ascension Thursday: RCA closed, no work." },
    { n: 31, sections: [{ label: "Week 31 (May 3-7)", text: "Monday — Practice Lesson XXX-XXXI. Latin Quiz: Lesson XXX-XXXI. HW Check: Lesson XXX - Ex. I, III, IV & Lesson XXXI - Ex. II, III, IV, V. Introduce Lesson XXXII." }, { label: "Week 31 (May 3-7)", text: "Thursday — Teach Lesson XXXII (Second Conjugation Perfect System), following the Teacher's Manual." }] },
    { n: 32, sections: [{ label: "Week 32 (May 10-14)", text: "Monday — Teach Lesson XXXIII (Unit V Review), following the Teacher's Manual." }, { label: "Week 32 (May 10-14)", text: "Thursday — HW Check: Lesson XXXII - Ex. II, III, IV, V, VII & Lesson XXXIII - Ex. II, III, IV, V. Review all vocabulary on the Drill Sheets at the end of the Student Workbook — make it a game!" }] },
